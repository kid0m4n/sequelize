...
module.exports = (function() {
  ...
  */
  ...
  AbstractQuery.prototype.formatResults = function(data) {
    ...
    if (this.isInsertQuery.call(this, data)) {
      handleInsertQuery.call(this, data)
    }

    if (this.isSelectQuery.call(this)) {
      result = handleSelectQuery.call(this, data)
    } else if (this.isShowTableQuery.call(this)) {
      result = handleShowTableQuery.call(this, data)
    } else if (this.isShowOrDescribeQuery.call(this)) {
      result = data
    } else if (this.isCallQuery.call(this)) {
      result = data[0]
    }
