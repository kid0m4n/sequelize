...
module.exports = (function() {
  ...
  DAOFactory.prototype.init = function(daoFactoryManager) {
    ...
    this.DAO.prototype.integerValues = [];
    this.DAO.prototype.floatValues = [];
    ...
    Utils._.each(this.rawAttributes, function (definition, name) {
      ...
      if(((definition === DataTypes.INTEGER) || (definition.type === DataTypes.INTEGER))) {
        self.DAO.prototype.integerValues.push(name);
      }
      if(((definition === DataTypes.FLOAT) || (definition.type === DataTypes.FLOAT))) {
        self.DAO.prototype.floatValues.push(name);
      }
